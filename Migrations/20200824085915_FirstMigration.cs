...
namespace VinhSyIntro.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PLanguage_Name = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Programming_Id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Courses_Programming_Languages_Programming_Id",
                        column: x => x.Programming_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_Programming_Id",
                table: "Courses",
                column: "Programming_Id");
        }
